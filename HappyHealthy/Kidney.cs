    ...
    public class Kidney : Activity
    {
        protected override void OnCreate(Bundle savedInstanceState)
        {
            ...
            saveButton.Click += delegate
            {
                ...
                KidneyTable.InsertKidneyToSQL(field_gfr.Text, field_creatinine.Text, field_bun.Text, field_sodium.Text, field_potassium.Text, field_albumin_blood.Text, field_albumin_urine.Text, field_phosphorus_blood.Text, 1);
