...
namespace HappyHealthyCSharp
{
    ...
    static class DatabaseHelperExtension
    {
        ...
        private static void CreateTriggers(SQLiteConnection c)
        {
            ...
            c.Execute("CREATE TRIGGER DiabetesTABLE_After_Delete_Trigger AFTER DELETE ON DiabetesTABLE BEGIN insert into TEMP_DiabetesTABLE(fbs_id_pointer, fbs_time_old, fbs_fbs_old, fbs_fbs_lvl_old, MODE) values(OLD.fbs_id, OLD.fbs_time, OLD.fbs_fbs, OLD.fbs_fbs_lvl, 'D'); END");
            c.Execute("CREATE TRIGGER DiabetesTABLE_After_Insert_Trigger AFTER INSERT ON DiabetesTABLE BEGIN insert into TEMP_DiabetesTABLE(fbs_id_pointer, fbs_time_new, fbs_fbs_new, fbs_fbs_lvl_new, MODE) values(NEW.fbs_id, NEW.fbs_time, NEW.fbs_fbs, NEW.fbs_fbs_lvl, 'I'); END");
            c.Execute("CREATE TRIGGER DiabetesTABLE_After_Update_Trigger AFTER UPDATE ON DiabetesTABLE BEGIN insert into TEMP_DiabetesTABLE(fbs_id_pointer, fbs_time_old, fbs_fbs_old, fbs_fbs_lvl_old, fbs_time_new, fbs_fbs_new, fbs_fbs_lvl_new, MODE) values(OLD.fbs_id, OLD.fbs_time, OLD.fbs_fbs, OLD.fbs_fbs_lvl, NEW.fbs_time, NEW.fbs_fbs, NEW.fbs_fbs_lvl, 'U'); END");
            //c.Execute("CREATE TABLE `TEMP_PressureTABLE`(`bp_id_pointer` int, `bp_time_new` bigint , `bp_time_old` bigint , `bp_up_new` float , `bp_up_old` float , `bp_lo_new` float , `bp_lo_old` float , `bp_hr_new` integer , `bp_hr_old` integer , `bp_up_lvl_new` integer , `bp_up_lvl_old` integer , `bp_lo_lvl_new` integer , `bp_lo_lvl_old` integer , `bp_hr_lvl_new` integer , `bp_hr_lvl_old` integer , MODE varchar(255))");
            ...
            c.Execute("CREATE TRIGGER PressureTABLE_After_Insert_Trigger AFTER INSERT ON PressureTABLE BEGIN insert into TEMP_PressureTABLE(bp_id_pointer, bp_time_new ,bp_up_new ,bp_lo_new ,bp_hr_new ,bp_up_lvl_new ,bp_lo_lvl_new ,bp_hr_lvl_new ,MODE) values(NEW.bp_id, NEW.bp_time ,NEW.bp_up ,NEW.bp_lo ,NEW.bp_hr ,NEW.bp_up_lvl ,NEW.bp_lo_lvl ,NEW.bp_hr_lvl ,'I'); END");
            c.Execute("CREATE TRIGGER PressureTABLE_After_UPDATE_Trigger AFTER UPDATE ON PressureTABLE BEGIN Insert into TEMP_PressureTABLE(bp_id_pointer, bp_time_old ,bp_up_old ,bp_lo_old ,bp_hr_old ,bp_up_lvl_old ,bp_lo_lvl_old ,bp_hr_lvl_old ,bp_time_new ,bp_up_new ,bp_lo_new ,bp_hr_new ,bp_up_lvl_new ,bp_lo_lvl_new ,bp_hr_lvl_new ,MODE) values(OLD.bp_id, OLD.bp_time ,OLD.bp_up ,OLD.bp_lo ,OLD.bp_hr ,OLD.bp_up_lvl ,OLD.bp_lo_lvl ,OLD.bp_hr_lvl ,NEW.bp_time ,NEW.bp_up ,NEW.bp_lo ,NEW.bp_hr ,NEW.bp_up_lvl ,NEW.bp_lo_lvl ,NEW.bp_hr_lvl ,'U'); END");
            c.CreateTable<TEMP_KidneyTABLE>();
            c.Execute("CREATE TRIGGER KidneyTABLE_After_DELETE_Trigger AFTER DELETE ON KidneyTABLE BEGIN INSERT INTO `TEMP_KidneyTABLE`(`ckd_id_pointer`, `ckd_time_old` , `ckd_gfr_old` , `ckd_gfr_level_old` , `ckd_creatinine_old` , `ckd_bun_old` , `ckd_sodium_old` , `ckd_potassium_old` , `ckd_albumin_blood_old` , `ckd_albumin_urine_old` , `ckd_phosphorus_blood_old` , `MODE`) VALUES(OLD.ckd_id, OLD.ckd_time , OLD.ckd_gfr , OLD.ckd_gfr_level , OLD.ckd_creatinine , OLD.ckd_bun , OLD.ckd_sodium , OLD.ckd_potassium , OLD.ckd_albumin_blood , OLD.ckd_albumin_urine , OLD.ckd_phosphorus_blood , 'D' ); END");
            c.Execute("CREATE TRIGGER KidneyTABLE_After_Insert_Trigger AFTER INSERT ON KidneyTABLE BEGIN INSERT INTO `TEMP_KidneyTABLE`(`ckd_id_pointer`, `ckd_time_new` , `ckd_gfr_new` , `ckd_gfr_level_new` , `ckd_creatinine_new` , `ckd_bun_new` , `ckd_sodium_new` , `ckd_potassium_new` , `ckd_albumin_blood_new` , `ckd_albumin_urine_new` , `ckd_phosphorus_blood_new` , `MODE`) VALUES(NEW.ckd_id, NEW.ckd_time , NEW.ckd_gfr , NEW.ckd_gfr_level , NEW.ckd_creatinine , NEW.ckd_bun , NEW.ckd_sodium , NEW.ckd_potassium , NEW.ckd_albumin_blood , NEW.ckd_albumin_urine , NEW.ckd_phosphorus_blood , 'I' ); END");
            c.Execute("CREATE TRIGGER KidneyTABLE_After_UPDATE_Trigger AFTER UPDATE ON KidneyTABLE BEGIN INSERT INTO `TEMP_KidneyTABLE`(`ckd_id_pointer`, `ckd_time_new` , `ckd_time_old` , `ckd_gfr_new` , `ckd_gfr_old` , `ckd_gfr_level_new` , `ckd_gfr_level_old` , `ckd_creatinine_new` , `ckd_creatinine_old` , `ckd_bun_new` , `ckd_bun_old` , `ckd_sodium_new` , `ckd_sodium_old` , `ckd_potassium_new` , `ckd_potassium_old` , `ckd_albumin_blood_new` , `ckd_albumin_blood_old` , `ckd_albumin_urine_new` , `ckd_albumin_urine_old` , `ckd_phosphorus_blood_new` , `ckd_phosphorus_blood_old` , `MODE`) VALUES(OLD.ckd_id, NEW.ckd_time , OLD.ckd_time , NEW.ckd_gfr , OLD.ckd_gfr , NEW.ckd_gfr_level , OLD.ckd_gfr_level , NEW.ckd_creatinine , OLD.ckd_creatinine , NEW.ckd_bun , OLD.ckd_bun , NEW.ckd_sodium , OLD.ckd_sodium , NEW.ckd_potassium , OLD.ckd_potassium , NEW.ckd_albumin_blood , OLD.ckd_albumin_blood , NEW.ckd_albumin_urine , OLD.ckd_albumin_urine , NEW.ckd_phosphorus_blood , OLD.ckd_phosphorus_blood , 'U' ); END");
